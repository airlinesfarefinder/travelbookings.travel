        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <a href="#" class="deal-link">
                    <div class="deal-card asia-theme">
                        <div class="deal-image">
                            <img src="./images/cruise/outdoor-home-ocean-architecture-lounge.jpg">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <a href="#" class="deal-link">
                    <div class="deal-card asia-theme">
                        <div class="deal-image">
                            <img src="./images/cruise/beautiful-landscape-sea-ocean-pattaya-thailand-with-boat.jpg">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <a href="#" class="deal-link">
                    <div class="deal-card asia-theme">
                        <div class="deal-image">
                            <img src="./images/cruise/futuristic-kitchen-interior-design.jpg">
