                ...
                <a href="#" class="deal-link">
                    <div class="deal-card europe-theme">
                        <div class="deal-image">
                            <img src="./images/flight/11.avif" alt="European city skyline at sunset">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <a href="#" class="deal-link">
                    <div class="deal-card oceania-theme">
                        <div class="deal-image">
                            <img src="./images/flight/12.jpg" alt="Sydney harbor with opera house and bridge">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <a href="#" class="deal-link">
                    <div class="deal-card asia-theme">
                        <div class="deal-image">
                            <img src="./images/flight/13.avif" alt="Traditional Japanese temple with cherry blossoms">
